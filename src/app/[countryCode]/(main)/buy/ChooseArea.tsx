               ...
               <div className="row gy-5">
                  <div className="col-lg-7">
                     <div className="section-title mb-0">
                        <h2 className="title style2">LuxuryVerse : Our Plan Ahead</h2>
                        <p className="sec-text">Leading the way in luxury ecommerce
                        </p>
                     </div>
                  </div>
               ...
               {/* <div className="col-lg-5"> */}
                  {/* <div className="wcu-amount-quantity">
                     <div className="amount">
                        <h5 className="title">Fact 1</h5>
                        <p className="price">50,000 $</p>
                     </div>
                     <div className="quantity">
                        <h5 className="title">Fact 2</h5>
